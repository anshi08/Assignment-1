...
const LandingPageDesktop = () => {
  return (
    <div className="relative w-full h-[3527px] text-left text-3xl text-primary font-source-sans-pro">
      ...
      <section className="absolute top-[2451px] left-[1px] w-[1440px] h-[362px] text-left text-[18.84px] text-primary font-source-sans-pro">
        <div className="absolute top-[0px] left-[0px] w-[1440px] h-[362px]">
          ...
          <div className="absolute top-[84px] left-[474px] w-[232px] h-[186px]">
            ...
            <div className="absolute top-[41px] left-[0px] w-[232px] h-[145px] text-[14.66px] text-dimgray">
          ...
          <div className="absolute top-[84px] left-[898px] w-[438px] h-[186px]">
            <div className="absolute top-[0px] left-[0px] tracking-[0.03em] leading-[27.22px] font-semibold inline-block w-auto h-[27px]">
              More
            </div>
            <div className="absolute top-[0px] left-[309px] text-[19px] tracking-[0.03em] leading-[27px] font-semibold inline-block w-[129px] h-[27px]">
              Social Links
            </div>
        ...
        />
        <img
          className="absolute h-[19.06%] w-[4.79%] top-[27.07%] right-[9.44%] bottom-[53.87%] left-[85.76%] max-w-full overflow-hidden max-h-full"
          alt=""
          src="/component1.svg"
        />
        <img
      ...
      <div className="absolute top-[989px] left-[205px] w-96 h-[468px]">
        ...
        <img
          className="absolute top-[341.61px] left-[53.39px] w-[25.71px] h-[47px] object-contain"
          alt=""
        />
      </div>
      ...
      <img
        className="absolute top-[162.72px] left-[1215.53px] w-[115.11px] h-[76.82px] object-cover hidden"
        alt=""
      />
      <section className="absolute top-[1614px] left-[108px] w-[1225px] h-[679px] text-left text-2xl text-primary font-poppins">
        ...
        <div className="absolute top-[125px] left-[0px] w-[381px] h-[554px]">
          ...
          />
          <div className="absolute top-[319.51px] left-[43.17px] w-[295.02px] h-[194.52px] flex flex-col items-start justify-start gap-[27.41px]">
        ...
        <div className="absolute top-[125px] left-[422px] w-[381px] h-[554px]">
          <div className="absolute top-[0px] left-[0px] w-[381px] h-[554px]">
            <div className="absolute top-[0px] left-[0px] rounded-[20.94px] bg-white box-border w-[381px] h-[554px] border-[1.4px] border-solid border-lightsteelblue" />
            <div className="absolute top-[319.51px] left-[43.17px] flex flex-col items-start justify-start gap-[27.41px]">
      ...
      <div className="absolute top-[2358px] leading-[27.22px] text-darkslategray" style={{left:'660px'}}>
        1/2
      </div>
      <div className="absolute h-[0.82%] w-[1.94%] top-[66.83%] right-[52.01%] bottom-[32.35%] left-[46.04%]">
        <img
          className="absolute h-[55.17%] w-[35.71%] top-[24.14%] right-[32.14%] bottom-[20.69%] left-[32.14%] max-w-full overflow-hidden max-h-full object-contain"
          alt=""
          src="/image-1-traced@2x.png"
        />
        <div className="absolute top-[0px] left-[0px] rounded-8xs bg-gainsboro box-border w-7 h-[29px] border-[1px] border-solid border-darkgray" />
      </div>
      <img
        className="absolute h-[0.82%] w-[1.94%] top-[66.83%] right-[46.04%] bottom-[32.35%] left-[52.01%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/group-323@2x.png"
      />
      <section className="absolute top-[1457px] left-[1440px] bg-white w-[1440px] h-[994px]" />
      <div className="absolute top-[2359px] leading-[27.22px] text-darkslategray" style={{left:'2013px'}}>
        2/2
      </div>
      <div className="absolute h-[0.82%] w-[1.94%] top-[66.86%] right-[-47.99%] bottom-[32.32%] left-[146.04%]">
        <img
          ...
          src="/image-1-traced@2x.png"
        />
        <div className="absolute top-[0px] left-[0px] rounded-8xs bg-gainsboro box-border w-7 h-[29px] border-[1px] border-solid border-darkslategray" />
      </div>
      <img
        className="absolute h-[0.82%] w-[1.94%] top-[66.86%] right-[-53.96%] bottom-[32.32%] left-[152.01%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/group-325@2x.png"
      />
      <section className="absolute top-[1615px] left-[1554px] w-[1225px] h-[679px] text-left text-2xl text-primary font-poppins">
        <h1 className="m-0 absolute top-[0px] left-[0px] text-37xl tracking-[0.04em] leading-[42px] font-semibold font-source-sans-pro inline-block w-[461px] h-[84px]">
          Latest Articles
        </h1>
        <div className="absolute top-[125px] left-[0px] w-[381px] h-[554px]">
